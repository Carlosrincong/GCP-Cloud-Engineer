...
**User-written logs** are logs written by custom applications and services. These logs are written to Cloud Logging by using **Ops Agent or Cloud Logging API or Cloud Logging client libraries**.
